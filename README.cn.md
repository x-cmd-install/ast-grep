...
[![x-cmd/install — ast-grep Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/ast-grep.svg?lang=zh)](https://x-cmd.com/install/ast-grep)
...
合计: **79,462** 行代码（覆盖前 5 种语言、共 **241** 个文件）。
...
- **Star**: 16,012 · **Fork**: 457 · **开放 issue**: 758 · **贡献者**: 93

## 累计统计

- **发布数**: 183 · **已合并 PR**: 1763 · **开放 PR**: 20 · **已关闭 issue**: 711 · **开放 issue**: 47 · **提交数**: 4360
...
_数据快照: `data/card/260924.yml` · 2026-09-24T05:44:26Z._
