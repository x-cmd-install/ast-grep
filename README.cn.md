...
[![x-cmd/install — ast-grep Code Quality Monitoring Repo Card](https://repo.x-cmd.io/ast-grep.svg?lang=zh)](https://x-cmd.com/install/ast-grep)
...
- **Star**: 15,966 · **Fork**: 454 · **开放 issue**: 756 · **贡献者**: 92

## 累计统计

- **发布数**: 183 · **已合并 PR**: 1756 · **开放 PR**: 23 · **已关闭 issue**: 711 · **开放 issue**: 45 · **提交数**: 4353
...
_数据快照: `data/card/260920.yml` · 2026-09-20T06:09:01Z._
